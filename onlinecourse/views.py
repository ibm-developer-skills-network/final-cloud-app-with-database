...
def show_exam_result(request, course_id, submission_id):
    ...
    correct_choices = Choice.objects.filter(
        question__lesson__course=course, is_correct=True)
    selected_correct_choices = correct_choices.filter(
        id__in=selected_choice_ids)

    # Calculate the total score
    total_questions = correct_choices.count()
    total_correct = selected_correct_choices.count()
